...
svglite(file = 'Fig2_a.svg', pointsize = pointsize, width = width*2, height = height)
...
svglite(file = 'Fig2_b.svg', pointsize = pointsize, width = width, height = height)
...
svglite(file = 'Fig2_c.svg', pointsize = pointsize, width = width, height = height)
...
svglite(file = 'Fig2_d.svg', pointsize = pointsize, width = width, height = height)
...
svglite(file = 'Fig2_e.svg', pointsize = pointsize, width = width, height = height)
...
svglite(file = 'Fig2_f.svg', pointsize = pointsize, width = width, height = height)
...
svglite(file = 'Fig2_g.svg', pointsize = pointsize, width = width, height = height)
